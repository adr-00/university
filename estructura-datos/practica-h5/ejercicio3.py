...
e2 = g.insert_edge(v1, v3)
e3 = g.insert_edge(v1, v4)
e4 = g.insert_edge(v2, v3)
e5 = g.insert_edge(v2, v4)
e6 = g.insert_edge(v3, v4)
e7 = g.insert_edge(v4, v6)
e8 = g.insert_edge(v5, v6)
e9 = g.insert_edge(v5, v7)
e10 = g.insert_edge(v5, v8)
e11 = g.insert_edge(v6, v7)
e12 = g.insert_edge(v7, v8)"""
